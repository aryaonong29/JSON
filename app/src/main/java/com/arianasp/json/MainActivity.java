...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv_name = (TextView)findViewById(R.id.tv1);
        TextView tv_city = (TextView)findViewById(R.id.tv2);
        TextView tv_province = (TextView)findViewById(R.id.tv3);
